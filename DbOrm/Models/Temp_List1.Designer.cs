...
namespace DbOrm.Model
{
    ...
    /// 备用表
    /// </summary>
    public partial class Temp_List1 : IModel
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        {
            return "insert into Temp_List1(TypeID,Name,Content,CreateTime,Temp1,Temp2,Temp3,Temp4,Temp5,Temp6,Temp7,Temp8,Temp9,Temp10) values(@TypeID,@Name,@Content,@CreateTime,@Temp1,@Temp2,@Temp3,@Temp4,@Temp5,@Temp6,@Temp7,@Temp8,@Temp9,@Temp10)";
        }
        ...
        internal override string UpdateSql()
        {
            ...
            return "update Temp_List1 set " + str.Remove(0, 1);
        }
    }
}
