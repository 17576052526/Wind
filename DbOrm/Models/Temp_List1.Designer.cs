...
namespace DbOrm.Model
{
    ...
    public partial class Temp_List1 : IModel
    {
        ...
        {
            return "insert into Temp_List1(TypeID,Name,Content,Img,Sort,Time,Temp1,Temp2,Temp3,Temp4,Temp5) values(@TypeID,@Name,@Content,@Img,@Sort,@Time,@Temp1,@Temp2,@Temp3,@Temp4,@Temp5)";
        }
