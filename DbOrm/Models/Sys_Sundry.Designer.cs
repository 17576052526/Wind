...
namespace DbOrm.Model
{
    ...
    public partial class Sys_Sundry : IModel
    {
        ...
        {
            return "insert into Sys_Sundry(TypeID,Name,Content,Img,Url,Time,Temp1,Temp2,Temp3,Temp4,Temp5) values(@TypeID,@Name,@Content,@Img,@Url,@Time,@Temp1,@Temp2,@Temp3,@Temp4,@Temp5)";
        }
