...
namespace DbOrm.Model
{
    ...
    public partial class Temp_List4 : IModel
    {
        ...
        {
            return "insert into Temp_List4(TypeID,Name,Content,CreateTime,Temp1,Temp2,Temp3,Temp4,Temp5,Temp6,Temp7,Temp8,Temp9,Temp10) values(@TypeID,@Name,@Content,@CreateTime,@Temp1,@Temp2,@Temp3,@Temp4,@Temp5,@Temp6,@Temp7,@Temp8,@Temp9,@Temp10)";
        }
