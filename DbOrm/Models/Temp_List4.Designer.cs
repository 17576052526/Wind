...
namespace DbOrm.Model
{
    ...
    public partial class Temp_List4 : IModel
    {
        ...
        {
            return "insert into Temp_List4(TypeID,Name,Content,Img,Url,Temp1,Temp2,Temp3,Temp4,Temp5) values(@TypeID,@Name,@Content,@Img,@Url,@Temp1,@Temp2,@Temp3,@Temp4,@Temp5)";
        }
