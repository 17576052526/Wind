...
namespace DbOrm.Model
{
    ...
    public partial class Temp_List5 : IModel
    {
        ...
        {
            return "insert into Temp_List5(TypeID,Name,Content,Img,Url,Time,Temp1,Temp2,Temp3,Temp4,Temp5) values(@TypeID,@Name,@Content,@Img,@Url,@Time,@Temp1,@Temp2,@Temp3,@Temp4,@Temp5)";
        }
