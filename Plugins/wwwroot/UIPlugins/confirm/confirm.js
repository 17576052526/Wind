...
$.confirm = function (content, yesFunc, title, noFunc) {
    ...
    $('<span class="confirm-remove">+</span>').appendTo(boxHead).on('click', function () { $('#confirm_394,#confirm_815').remove() })
}