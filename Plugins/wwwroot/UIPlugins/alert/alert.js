...
$.alert = function (msg) {
    ...
    var msgBox = $('<div class="alert"><div style="max-height:75vh;overflow:auto;"><div class="alert-remove" onclick="$(this).closest(\'.alert\').remove()">+</div>' + msg + '</div></div><br>').appendTo(box);//<br>用于换行
